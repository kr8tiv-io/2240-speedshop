...
function readTarget() {
  // Same three-way read as the camera rig: on iOS Safari an overflow-clipped
  // body can be the real scroller, and the wrong sources read 0.
  const y = Math.max(
    window.scrollY || 0,
