...
import { stationOf, subscribe } from "./StationReveal";
  ...
  return (
    <div className={travelling ? "cine-on" : ""}>
      ...
      <nav
        ...
        className="station-rail fixed right-5 top-1/2 z-20 hidden -translate-y-1/2 flex-col items-end gap-4 lg:flex"
      >
        {STOPS.map((name, i) => (
          <button
            key={name}
