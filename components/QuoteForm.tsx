...
const cardClass =
  "flex cursor-pointer items-start gap-3 border border-rust/35 bg-panel p-4 transition-colors hover:border-rust/70 has-[:checked]:border-speed-red has-[:checked]:bg-speed-red/10";
      ...
      <div className="plate p-6 sm:p-8" role="status">
        ...
        <div className="mt-5 flex flex-col gap-3 sm:flex-row">
          ...
          <button
            type="button"
            onClick={reset}
            className="px-2 py-3 text-center font-sub text-xs uppercase tracking-[0.2em] text-steel underline decoration-rust underline-offset-4 transition-colors hover:text-bone"
          >
            Start another
          </button>
        </div>
  ...
  return (
    <div className="plate p-6 sm:p-8">
      ...
      <div className="mt-4 h-px w-full bg-rust/25">
        <div
          className="h-px bg-speed-red transition-all duration-500"
      ...
      <form onSubmit={handleSubmit} noValidate className="mt-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="mt-2 w-full cursor-pointer border border-dashed border-rust/50 bg-bay-black px-3 py-4 font-body text-sm text-steel file:mr-4 file:border file:border-speed-red/60 file:bg-transparent file:px-4 file:py-2 file:font-sub file:text-[11px] file:uppercase file:tracking-[0.2em] file:text-bone hover:border-rust"
                />
              ...
              <fieldset>
                ...
                <div className="mt-3 flex flex-wrap gap-3">
                  {METHODS.map((m) => (
                    <label
                      key={m}
                      className="flex cursor-pointer items-center gap-3 border border-rust/35 bg-panel px-5 py-3 transition-colors hover:border-rust/70 has-[:checked]:border-speed-red has-[:checked]:bg-speed-red/10"
                    >
                      <input
                        type="radio"
                        name="method"
        ...
        <div className="flex flex-col-reverse gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button
            type="submit"
            className="flicker border border-speed-red/70 px-8 py-4 font-sub text-xs uppercase tracking-[0.24em] text-bone transition-all hover:border-neon-bloom hover:shadow-[0_0_22px_rgba(224,69,69,0.45)]"
          >
