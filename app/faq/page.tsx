    ...
    <>
      ...
      <section className="border-b border-rust/25">
        <div className="mx-auto max-w-6xl px-5 py-16 sm:py-20">
          ...
          <h1 data-fx="h" className="mt-4 max-w-4xl font-display text-5xl leading-[0.92] tracking-wide text-bone sm:text-7xl">
      ...
      {/* --------------------------------------------------------------- cta */}
      <section className="mx-auto max-w-6xl px-5 py-16">
        <div className="flex flex-col gap-6 border border-tungsten/45 p-8 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex shrink-0 flex-col gap-3 sm:flex-row">
            <Link
              href="/quote"
              className="border border-tungsten/70 px-6 py-3 text-center font-sub text-xs uppercase tracking-[0.2em] text-bone transition-all hover:border-neon-bloom hover:shadow-[0_0_24px_rgba(255,176,102,0.15)]"
            >
              Get a quote
            </Link>
            <a
        ...
        <p className="mt-8 font-body text-[15px] leading-relaxed text-steel">
          ...
          <Link className="text-tungsten underline decoration-tungsten/40 underline-offset-4 hover:text-bone" href="/guides">
            guides
          </Link>
          . What the shop is and who runs it is on{" "}
          <Link className="text-tungsten underline decoration-tungsten/40 underline-offset-4 hover:text-bone" href="/about">
            about Terry
          </Link>
