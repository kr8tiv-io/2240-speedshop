    ...
    <>
      ...
      <section className="mx-auto max-w-6xl px-5 py-16">
        <div className="grid gap-12 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,1fr)] lg:items-start">
          ...
          <figure className="lg:sticky lg:top-24">
            <div data-fx="mask" className="plate relative aspect-[3/4] overflow-hidden">
              <Image
      ...
      <section className="mx-auto max-w-6xl px-5 py-16">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <figure>
            <div data-fx="mask" className="plate relative aspect-[4/3] overflow-hidden">
              <Image
      ...
      <section className="mx-auto max-w-6xl px-5 pb-20">
        <div className="flex flex-col gap-6 border border-tungsten/45 p-8 sm:flex-row sm:items-center sm:justify-between">
