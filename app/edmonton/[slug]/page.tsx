    ...
    <div className="mx-auto max-w-6xl px-5 py-14 sm:py-20">
      ...
      <header className="mt-8 grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
        <div>
          ...
          <h1 data-fx="h" className="mt-3 font-display text-5xl leading-[0.95] tracking-wide text-bone sm:text-6xl">
            {copy.h1}
          </h1>
          <div className="weld mt-6 max-w-md" />
          <p className="mt-6 text-lg leading-relaxed text-bone">{copy.lede}</p>
          <p className="mt-6 border-l-2 border-tungsten/70 pl-4 font-mono text-sm leading-relaxed text-tungsten">
            {copy.drive}
          </p>
      ...
      <section
        ...
        className="mt-16 border border-tungsten/50 bg-panel px-6 py-10 sm:px-10"
      >
