  ...
  return (
    <div className="mx-auto max-w-6xl px-5 py-14 sm:py-20">
      ...
      <header className="mt-8 max-w-3xl">
        <p className="font-sub text-xs uppercase tracking-[0.28em] text-neon-bloom">The proof layer</p>
            ...
            return (
              <li key={build.slug}>
                <Link
                  ...
                  className="plate group block h-full overflow-hidden"
                >
                  <div className={`relative w-full overflow-hidden ${cover.aspect}`}>
                    <div
                      className="absolute inset-0"
                      style={cover.zoom ? { transform: `scale(${cover.zoom})` } : undefined}
                    >
                      <Image
                        src={cover.src}
                        alt={cover.alt}
