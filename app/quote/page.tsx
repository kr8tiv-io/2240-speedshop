          ...
          <aside className="space-y-8 lg:sticky lg:top-24">
            ...
            <div className="border border-tungsten/45 p-6">
              ...
              <div className="mt-5 space-y-3">
                <a
                  href={`tel:${site.phone}`}
                  className="block border border-tungsten/70 px-5 py-3 text-center font-sub text-xs uppercase tracking-[0.2em] text-bone transition-all hover:border-neon-bloom hover:shadow-[0_0_24px_rgba(255,176,102,0.15)]"
                >
                  {site.phoneDisplay}
                </a>
                <a
