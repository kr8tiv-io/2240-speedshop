    ...
    <>
      ...
      <section className="relative overflow-hidden border-b border-rust/25">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Finished red stepside pickup built by 2240 Speed Shop in Edmonton"
            fill
            priority
            sizes="100vw"
        ...
        <div className="relative mx-auto max-w-6xl px-5 py-20 sm:py-24">
          ...
          <h1 data-fx="h" className="mt-4 max-w-3xl font-display text-5xl leading-[0.92] tracking-wide text-bone sm:text-7xl">
          ...
          <aside className="space-y-8 lg:sticky lg:top-24">
              ...
              <ul className="mt-5 space-y-3">
                {photoChecklist.map((item) => (
                  <li key={item} className="flex gap-3 font-body text-sm leading-relaxed text-steel">
                    <span aria-hidden="true" className="mt-[7px] h-1.5 w-1.5 shrink-0 rotate-45 bg-tungsten" />
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
            ...
            <div className="border border-tungsten/45 p-6">
              ...
              <div className="mt-5 space-y-3">
                <a
                  href={`tel:${site.phone}`}
                  className="block border border-rust px-5 py-3 text-center font-sub text-xs uppercase tracking-[0.2em] text-bone transition-all hover:border-neon-bloom hover:-translate-y-0.5 hover:shadow-[0_10px_26px_rgba(20,20,20,0.12)]"
                >
                  {site.phoneDisplay}
                </a>
                <a
      ...
      <section className="mx-auto max-w-3xl px-5 pb-20">
        ...
        <p className="mt-10 font-body text-[15px] leading-relaxed text-steel">
          More of them on the{" "}
          <Link className="text-tungsten underline decoration-tungsten/40 underline-offset-4 hover:text-bone" href="/faq">
            restoration FAQ
          </Link>
          ...
          <Link className="text-tungsten underline decoration-tungsten/40 underline-offset-4 hover:text-bone" href="/builds">
            builds
          </Link>{" "}
          or the{" "}
          <Link className="text-tungsten underline decoration-tungsten/40 underline-offset-4 hover:text-bone" href="/reviews">
            reviews
          </Link>
          .
        </p>
