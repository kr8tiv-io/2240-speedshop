    ...
    <>
      ...
      <section className="relative overflow-hidden border-b border-rust/25">
        ...
        <div className="relative mx-auto max-w-4xl px-5 pb-16 pt-20 sm:pt-28">
          ...
          <h1 className="mt-4 font-display text-5xl leading-[0.95] tracking-wide text-bone sm:text-7xl">
            Straight answers,
            <br />
      ...
      <section className="mx-auto max-w-6xl px-5 py-16 sm:py-20">
        ...
        <p className="mt-4 max-w-3xl leading-relaxed text-steel">
          ...
          <Link href="/services" className="text-bone underline decoration-rust underline-offset-4 hover:text-neon-bloom">
            service pages
          </Link>{" "}
          and the{" "}
          <Link href="/builds" className="text-bone underline decoration-rust underline-offset-4 hover:text-neon-bloom">
            build case studies
          </Link>
