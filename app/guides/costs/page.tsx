        ...
        <div className="mx-auto max-w-4xl px-5">
          ...
          <section className="py-14 sm:py-16">
            ...
            <ul className="mt-7 space-y-5">
              <li className="flex gap-4">
                <span aria-hidden className="mt-[9px] h-[7px] w-[7px] shrink-0 rotate-45 bg-tungsten" />
          ...
          <section className="py-14 sm:py-16">
            ...
            <p className="mt-5 leading-relaxed text-steel">
              ...
              <Link href="/guides/winter" className="text-bone underline decoration-tungsten/40 underline-offset-4 hover:text-neon-bloom">
                winter guide
              </Link>{" "}
