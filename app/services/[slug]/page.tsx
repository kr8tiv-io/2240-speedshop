  ...
  return (
    <article className="mx-auto w-full max-w-6xl px-5 pb-24 pt-10">
      ...
      <figure className="mt-10">
        <div className="relative aspect-[16/9] w-full overflow-hidden border border-rust/30">
          <Image
            src={s.image}
            alt={s.alt}
            fill
          ...
          {siblings.map((sib) => (
            <li key={sib.slug} className="plate p-6">
              ...
              <Link
                ...
                className="mt-4 inline-block font-sub text-[11px] uppercase tracking-[0.2em] text-tungsten underline decoration-rust underline-offset-4 hover:text-bone"
              >
                {sib.nav} details
              </Link>
            </li>
