    ...
    <div className="mx-auto w-full max-w-6xl px-5 pb-24 pt-10">
      ...
      <section aria-labelledby="trades" className="mt-14">
        ...
        <ul className="mt-10 grid gap-8 md:grid-cols-2">
          {services.map((s) => (
            <li key={s.slug} className="backlit flex flex-col !bg-transparent">
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <Link
                  ...
                  className="mt-6 inline-block self-start border border-tungsten/70 px-4 py-2 font-sub text-[11px] uppercase tracking-[0.2em] text-bone transition-all hover:border-neon-bloom hover:shadow-[0_0_24px_rgba(255,176,102,0.15)]"
                >
                  {s.nav} details
                </Link>
              </div>
