  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-5 pb-24 pt-10">
      ...
      <header className="mt-8 max-w-5xl">
        <p className="corner-note text-tungsten">WHAT WE DO — ALL OF IT, HERE</p>
        <Kinetic
          as="h1"
          trigger="mount"
          className="mt-4 font-display text-[clamp(3rem,9vw,7.5rem)] uppercase leading-[0.88] tracking-wide text-bone"
        >
      ...
      <section aria-labelledby="trades" className="mt-14">
        ...
        <ul className="mt-10 grid gap-8 md:grid-cols-2">
          {services.map((s, i) => (
            <li
              key={s.slug}
              className="backlit flex flex-col !bg-transparent"
              {...(i % 2 === 1 ? { "data-drift": "26" } : {})}
            >
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <Link
                  ...
                  className="mt-6 inline-block self-start border border-rust px-4 py-2 font-sub text-[11px] uppercase tracking-[0.2em] text-bone transition-all hover:border-neon-bloom hover:-translate-y-0.5 hover:shadow-[0_10px_26px_rgba(20,20,20,0.12)]"
                >
                  {s.nav} details
                </Link>
              </div>
