...
const destinations = [
  { href: "/services", title: "Services", blurb: "Metal, motor, colour, trim. All of it here." },
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-4xl px-5 py-24 sm:py-32">
        ...
        <h1 data-fx="h" className="mt-6 font-display text-7xl leading-[0.85] tracking-wide text-bone sm:text-9xl">
          ...
          {services.map((s) => (
            <li key={s.slug} className="flex gap-3 text-sm leading-relaxed">
              ...
              <Link
                ...
                className="text-steel underline decoration-tungsten/40/60 underline-offset-4 transition-colors hover:text-bone"
              >
                {s.title}
              </Link>
            </li>
