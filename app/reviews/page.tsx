...
export default function ReviewsPage() {
  ...
  return (
    <>
      ...
      {/* -------------------------------------------------------- leave one */}
      <section className="mx-auto max-w-6xl px-5 py-16">
        <div className="grid gap-8 border border-speed-red/45 p-8 lg:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)] lg:items-center">
          <div>
          ...
          <div className="flex flex-col gap-3">
            <a
              ...
              className="flicker border border-speed-red/70 px-6 py-4 text-center font-sub text-xs uppercase tracking-[0.22em] text-bone transition-all hover:border-neon-bloom hover:shadow-[0_0_22px_rgba(224,69,69,0.45)]"
            >
              Review us on Google
            </a>
            <a
      ...
      <section className="mx-auto max-w-6xl px-5 pb-20">
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-3">
          {gallery.map((img) => (
            <div key={img.src} className="plate relative aspect-[4/3] overflow-hidden">
              <Image
                src={img.src}
                alt={img.alt}
                fill
