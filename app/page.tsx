...
export default function HomePage() {
  return (
    <div>
      ...
      {/* THE FILM — preloader, three cars, two written interludes — split
          around the shop: Acts I–II, then the 3D walk-through of the room
          itself, then Act III waiting at the far end. */}
      <WalkthroughWorld />
      <div className="-mt-[76px]">
        <HomeCinema walkthrough={<WalkthroughSections />} />
      </div>
