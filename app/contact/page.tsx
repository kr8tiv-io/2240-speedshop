    ...
    <>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-2">
              <a
                ...
                className="font-sub text-[11px] uppercase tracking-[0.2em] text-steel underline decoration-rust underline-offset-4 transition-colors hover:text-bone"
              >
      ...
      <section className="mx-auto max-w-6xl px-5 py-14">
        ...
        <div className="mt-10 flex flex-col gap-4 border border-rust/30 p-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Link
            href="/quote"
            className="shrink-0 border border-speed-red/70 px-6 py-3 text-center font-sub text-xs uppercase tracking-[0.2em] text-bone transition-all hover:border-neon-bloom hover:shadow-[0_0_18px_rgba(224,69,69,0.45)]"
          >
            Get a quote
          </Link>
        </div>
